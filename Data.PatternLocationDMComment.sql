...
-- Start date updated = FY2023 (2022-09-01) 
SELECT 		
	o.OPP_ID
	,o.SUMMARY
	,o.OPP_STATUS
...
WHERE 
	...
	AND o.DATE_INSERTED BETWEEN '2022-09-01 00:00:00.001' AND GETDATE() -- Tim update confirmed 2024-11-12 FY2023 will be the new start date
	AND o.OPP_GENERATED_TIME BETWEEN '2022-09-01 00:00:00.001' AND GETDATE() -- Tim update confirmed 2024-11-12 FY2023 will be the new start date
	AND o.EMP_NUMBER_ASSIGNEE NOT IN ('4118541','4118551','analyst@profitect.com','9999999','1959518','1432914','2634721','1950877','1440795','1445805','jim.hare'
		...
		,'1185165','4546396','4234682','1863183','1325015','4255465','4256323','1448552','4546413','4546391','4546246','4546399','2589783','4639125','james.vickery@zebra.com','4748046')
	...
	AND o.OPP_ID NOT IN ('2565116','2565168','5176215') -- Updated 2024.04.02 removing alerts that are inflating values
...
/*
-- Below Query was previous active query but updated to remove names and changed to reflect EMP_NUMBER
SELECT 		
	o.OPP_ID
	,o.SUMMARY
	,o.OPP_STATUS
